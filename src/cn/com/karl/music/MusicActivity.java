...
public class MusicActivity extends Activity implements OnSeekBarChangeListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		textStartTime = (TextView) this.findViewById(R.id.music_start_time);// 开始时间
		textEndTime = (TextView) this.findViewById(R.id.music_end_time);// 结束时间
	...
	protected void onStart() {
		...
		Music m = lists.get(id);//List<Music> lists
